...
<div class="hidden-print" style="text-align: center;"><a href="http://www.schoolifybd.com" target="_blank"> developed by <img src="../public/images/schoolify.png" width="40"/></a></div>
<hr>
...
<!-- data table plugin -->
<!--<script src='../public/DataTables-1.9.4/media/js/jquery.dataTables.min.js'></script>-->
<!--<script src='../public/DataTables-1.9.4/extras/TableTools/media/js/TableTools.min.js'></script>-->
...
<!--Table column wise filtering-->
<script src="../public/js/jquery.filterable.min.js"></script>
