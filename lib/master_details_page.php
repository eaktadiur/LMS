...
<a href="<?php echo $object_name; ?>.php?mode=new&main_id=<?php echo $main_id; ?>" class="create button">Create New</a>
<a href="<?php echo $object_name; ?>.php?main_id=<?php echo $main_id; ?>"><buttin class="button">Refresh</buttin></a>
