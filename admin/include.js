...
function loadGrid() {
    ...
    $('#dataGrid').datagrid({
        ...
        url: 'get.php',
        columns: [[
                {field: 'Word', title: 'Word Name'},
                {field: 'Phonetic_bg', title: 'Word Name'},
                {field: 'Phonetic_eng', title: 'Word Name'},
                {field: 'Sound', title: 'Word Name'},
                {field: 'DifficultyLevel', title: 'Word Name'}
            ]]
...
function Edit() {
    ...
    if (row) {
        ...
        $('#fm').form('load', row);
        url = 'save.php?mode=""&search_id=' + row.COUNTRY_ID;
    }
}
function Save() {
    //alert(22);
