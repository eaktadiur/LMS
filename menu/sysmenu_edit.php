...
WHERE ul.UserLevelId='$searchId' AND ul.UserLevelId<>1 #AND ul.CompanyId='$companyId'";
...
if (isSave()) {
    ...
    echo " <script>location.replace('sysmenu_edit.php?mode=search&searchId=$searchId');</script>";
}
        ...
        <div class="box-content">
            ...
            <form name='requisition' action="" method='post' id="requisition">
                ...
                <div class="form-actions">
                    <button type="submit" name="save" value="SaveSysMenu" class="btn btn-primary">
