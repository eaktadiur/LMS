...
$voucherTypeList = getVoucherType($companyId, 11);
    ...
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h3>
                ...
                <a href="#" class="button">Purchase Voucher: <?php echo $maxId; ?></a>
            </h3>
        </div>
        <div class="box-content">
            ...
            <form action="" method="POST" name='requisition' autocomplete="off">
                ...
                <hr/>
                <div class="center"><h2>Purchase Collection Voucher</h2></div>
