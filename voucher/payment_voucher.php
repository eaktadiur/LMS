...
if (isSave()) {
    ...
    savePaymentVoucher($employeeId, $companyId);
    echo "<script type='text/javascript'>location.replace('payment_voucher.php');</script>";
}
    ...
    <div class="box span12">
        <div class="box-header well" data-original-title>
            <h3>
                ...
                <a href="#">Payment Voucher: <?php echo $maxId; ?></a>
            </h3>
        </div>
        <div class="box-content">
            ...
            <form action="" class="" method="POST" autocomplete="off">
                ...
                <div class="center"><h2>Payment Voucher</h2></div>
                ...
                <table id="productGrid" class="table table-striped table-bordered bootstrap-datatable">
                    ...
                    <tbody>
                        <tr>
                            <td>01</td>
                            <td> 
                                <select name="ledgerId[]" id="ledgerId" class="ledgerId product form-input autoComplate">
                                    <option></option>
                                    <?php
                    ...
                    <th></th>
                    <th align="right"></th>
                    <th align="right"><div id="paymentTotal">00.00</div></th>
                    <th></th>
                    </tfoot>
                </table>
                <div class="row-fluid">
