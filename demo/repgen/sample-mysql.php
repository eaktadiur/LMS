...
//////////////////////////////////////////////////////////////////////////////////
require "db-mysql.inc";  // If you use another DB, alter db-mysql.inc to db-***.inc
                         // and don't forget to change repgen-def.inc
// Constants for database: insert the actual values
$database   = "<database>";
$host       = "<host>";
$user       = "<user>";
$password   = "<password>";
...
for ($i=0;$i<count($ar);$i++) {
  ...
  $long  = $a_attr[3];
?>
<form name="sample" action="sample-mysql.php" method="POST" >
<TD> <?php echo $long; ?> </TD>
<TD>
