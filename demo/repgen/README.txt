...
Installation:
-------------
This program is based on PHP 5.2.5 and phplib.
...
The constant REPGENDIR in the file 'repgen-def.inc' points to the directory, where the *.php - programs 
...
You can use the databases Mysql, Postgresql and ODBC if you decomment the specific constant DBDRIVER on the file 'repgen-def.inc'.
If you want the program to work in another language, set the constant LANGUAGE  to 'repgen-const-<language>.inc'.
Until now,there exist only german and english ('repgen-const-german.inc' and 'repgen-const-english.inc').
