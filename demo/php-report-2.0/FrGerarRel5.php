...
GerarRel::PegarPassos(5);
?>
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
  	<td align="center">&nbsp;</td>
  	<td>
<? GerarRel::ListarAgrupamento5($qtd_campos); ?>
	  </td>
 	</tr>
  <tr>
    <td align="center">&nbsp;</td>
  ...
  <tr>
  	...
  	<td><table width="268" border="0" cellpadding="0" cellspacing="0">
    	<tr>
    		...
    		<td><div align="center">
    			<input name="adi_campos5" type="text" class="texto" onKeyPress="return sonumero(event);" size="2" maxlength="1">
    			</div></td>
    		<td><div align="center"><?=_CAMPOS;?></div></td>
    		<td><div align="center">
    			<input type="submit" name="envia_campos5" value="<?=_OK;?>" class="botao_ok">
    			</div></td>
    		</tr>
    	</table></td>
 	</tr>
...
<? } ?>
  <tr>
    ...
    <td>
 	  <input type="button" onClick="javascript:EnviarForm('FrGerarRel4.php',document.form1);" value="<?=_VOLTAR;?>" class="botao_volt">&nbsp;&nbsp;&nbsp;
	  <input type="button" onClick="javascript:EnviarForm('FrGerarRel11.php',document.form1);" value="<?=_FINALIZAR;?>" class="botao_conf">&nbsp;&nbsp;&nbsp;
      <input type="button" onClick="javascript:EnviarForm('FrGerarRel6.php',document.form1);" value="<?=_AVANCAR;?>" class="botao_avanc"> </td>
  </tr>
</table>
</form>
<? Layout::Rodape(); ?>