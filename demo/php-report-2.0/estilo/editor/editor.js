...
document.write('.cMenu     { background-color: threedface; color: menutext; cursor: Default; font-family: Arial; font-size: 10pt; padding: 2 12 2 16; }');
document.write('.cMenuOver { background-color: highlight; color: highlighttext; cursor: Default; font-family: Arial; font-size: 10pt; padding: 2 12 2 16; }');
...
this.width =  "auto";
this.height = "auto";
this.bodyStyle = 'background-color: #FFFFFF; font-family: "Arial"; font-size: x-small;';
...
this.toolbar = [
    ...
    ['popupeditor','separator','about','htmlmode']];
