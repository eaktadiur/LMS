...
<? GerarRel::PegarPassos(2); ?>
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
  	<td width="60">&nbsp;</td>
  	<td>
<? GerarRel::ColocarTitulos2(); ?>
    </td>
 	</tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td>
	  <input type="button" onClick="javascript:EnviarForm('FrGerarRel1.php',document.form1);" value="<?=_VOLTAR;?>" class="botao_volt">&nbsp;&nbsp;&nbsp;
	  <input type="button" onClick="javascript:EnviarForm('FrGerarRel11.php',document.form1);" value="<?=_FINALIZAR;?>" class="botao_conf">&nbsp;&nbsp;&nbsp;
    <input type="button" onClick="javascript:EnviarForm('FrGerarRel3.php',document.form1);" value="<?=_AVANCAR;?>" class="botao_avanc"> </td>
  </tr>
</table>
</form>
<? Layout::Rodape(); ?>